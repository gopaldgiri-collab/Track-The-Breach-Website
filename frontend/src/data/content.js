...
export const FAQ_ITEMS = [
  ...
  { q: "How is pricing structured?", a: "Plans are outcome-based, not credit-based. You pay for the protection level (individuals → enterprise) and the number of monitored identities. Credits are exposed only as a secondary metric on detail dashboards." },
  { q: "Is there a free option?", a: "Yes. Anyone can run a free Exposure Report once per month covering email and phone. Continuous monitoring and managed takedowns require a paid plan." },
...
export const PRICING_PLANS = [
  {
    name: "Starter",
    audience: "Individuals starting their protection journey",
    price: "$0",
    period: "forever",
    cta: "Get Started Free",
    features: [
      "1 email + 1 phone monitored",
      "Monthly exposure report",
      "Basic breach alerts (email)",
  ...
  {
    name: "Professional",
    audience: "Privacy-conscious individuals & creators",
    price: "$12",
    period: "per month",
    cta: "Start Professional",
    features: [
      "5 emails + 3 phones + 5 socials",
      "Real-time alerts (push, email, SMS)",
      "Dark-web monitoring",
      "Photo & video exposure detection",
  ...
  },
  {
    name: "Business",
    highlight: true,
    audience: "Teams of 5–500 protecting workforce identity",
    price: "$249",
    period: "per month",
    cta: "Start Business",
    features: [
      ...
      "Managed takedowns (10/mo)",
      "Dedicated incident analyst",
      "REST API + webhooks",
      "Slack & Teams alerts",
      "SOC 2 evidence pack",
    ],
  ...
  {
    name: "Enterprise",
    audience: "Organizations of 500+ employees",
    price: "Custom",
  ...
  {
    name: "Full Secure",
    audience: "Executives, families, VIPs needing white-glove",
    price: "$1,499",
    period: "per month / household",
    cta: "Apply for Full Secure",
    features: [
      "Concierge security analyst",
      "Up to 10 protected individuals",
      "24/7 incident response hotline",
      "Physical-digital threat fusion",
      "Travel & relocation OSINT",
      "Reputation crisis management",
      "Annual deep-cover audit",
    ],
